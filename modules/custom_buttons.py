...
def create_mode_button(canvas, x, y, text, command):
    ...
    inactive_i = ImageTk.PhotoImage(Image.open(inactive_path).convert("RGBA"))
    active_i = ImageTk.PhotoImage(Image.open(active_path).convert("RGBA"))
