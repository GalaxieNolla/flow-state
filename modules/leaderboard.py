...
class Leaderboard:
    ...
    def open(self):
        ...
        self.canvas.create_text(lc, panel_y_left + 30, text="✦ Winner's Circle ✦",
            font=("Cinzel", 22, "bold"), fill=styles.JINX_BLUE)
        self.canvas.create_text(rc, panel_y_right + 50, text="✦ Current Session ✦",
            font=("Cinzel", 22, "bold"), fill="#e8a0c0")

        # dividers
        self.canvas.create_line(left_x + 190, panel_y_left + 50, left_x + panel_w_left - 100, panel_y_left + 50,
            fill=styles.JINX_BLUE, width=2)
        self.canvas.create_line(right_x + 80, panel_y_right + 70, right_x + panel_w_right - 70, panel_y_right + 70,
            fill="#e8a0c0", width=2)
